...
class PokeController(
    ...
    @GetMapping("/getAll/user_pokemon/{userId}")
    fun getAllPokemonByUserId(
        @PathVariable userId: Long
    ): ResponseEntity<GetAllPokemonByUserIdResponse> {
        return ResponseEntity.ok(service.getAllPokemonByUserId(userId))
    }
